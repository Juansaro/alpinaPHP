...
<head>
    ...
    <link rel="stylesheet" href="./css/login_alpina.css">
...
<body>
    ...
    <form action="./Controller/nuevoU.php" method="POST" enctype="multipart/form-data" autocomplete="off">
        <div class="titulo">
            <h1><img src="./img/logo_alpina.png" width="100" height="50"><a href="javascript:cerrar()"><ion-icon class="close-button" name="close" size="large"></ion-icon></a></h1>
        </div>
    ...
    <div class="container">
        ...
        <br>
            ...
            <div class="panel-hading text-center">
                <img src="./img/logo_alpina.png" width="400" height="200">
            </div>
            <div class="panel-hading text-center">
